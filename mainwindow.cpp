...
void MainWindow::on_EnumButton_clicked()
{
    ...
    {
        QMessageBox::information(this,QString::fromLocal8Bit("异常"),QString::fromLocal8Bit("查找设备失败"));
        return;
    }
...
void MainWindow::on_OpenButton_clicked()
{
    ...
    {
        QMessageBox::information(this,QString::fromLocal8Bit("异常"),QString::fromLocal8Bit("打开设备失败"));
        return;
    }
...
void MainWindow::on_CloseButton_clicked()
{
   ...
   {
        QMessageBox::information(this,QString::fromLocal8Bit("异常"),QString::fromLocal8Bit("关闭设备失败"));
        return;
   }
   ui->OpenButton->setDisabled(false);
   ui->CloseButton->setDisabled(false);
...
void MainWindow::on_StartGrabbingButton_clicked()
{
    ...
    {
         QMessageBox::information(this,QString::fromLocal8Bit("异常"),QString::fromLocal8Bit("采集设备失败"));
         return;
    }
...
void MainWindow::on_StopGrabbingButton_clicked()
{
   ...
   {
       QMessageBox::information(this,QString::fromLocal8Bit("异常"),QString::fromLocal8Bit("关闭采集失败"));
       return;
   }
   ui->StartGrabbingButton->setDisabled(false);
...
void MainWindow::on_SaveBmpButton_clicked()
{
   ...
   {
       QMessageBox::information(this,QString::fromLocal8Bit("异常"),QString::fromLocal8Bit("保存bmp失败"));
       return;
   }
   else {
       QMessageBox::information(this,QString::fromLocal8Bit("成功"),QString::fromLocal8Bit("保存图片成功"));
   }
}
...
void MainWindow::on_HardwareRadioButton_clicked()
{
    ...
    {
        QMessageBox::information(this, QString::fromLocal8Bit("异常"), QString::fromLocal8Bit("触发采集失败"));
    }
}
